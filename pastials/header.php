<?php
$primerionome = current(explode(' ', $userInfo->name));
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <header>
        <div class="container">
            <div class="logo">
                <a href="<?=$base;?>/perfil.php"><img src="<?=$base;?>/assets/images/devsbook_logo.png" /></a>
            </div>
            <div class="head-side">
                ...
                <div class="head-side-right">
                    <a href="<?=$base;?>/perfil.php" class="user-area">
                        <div class="user-area-text"><?=$primerionome;?></div>
